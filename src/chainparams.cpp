...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Enox: 1 day
        nTargetSpacing = 1 * 60;  // Enox: 1 minute
        nMaturity = 10;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Enox Developers April 30 2018";
        ...
        vSeeds.push_back(CDNSSeedData("2", "207.246.75.18"));
        ...
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x10)(0x70)(0x20)(0x21).convert_to_container<std::vector<unsigned char> >();
        ...
        strSporkKey = "045a3a128a4aae34c2fe82586c219bc2a0b23cf395b49bc67e35e8ffcb0bd84088620b174fa69a7c05d318732addd3ac5825950747f929cd0122fd5f8ebf5f40c9";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Enox: 1 day
        nTargetSpacing = 1 * 10;  // Enox: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 94); // Testnet enox addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet enox script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet enox BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet enox BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet enox BIP44 coin type is '1' (All coin's testnet default)
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x01)(0x04)(0x30)(0x22).convert_to_container<std::vector<unsigned char> >();
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Enox: 1 day
        nTargetSpacing = 1 * 60;        // Enox: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;
        genesis.nTime = 1525068726;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 12345;
